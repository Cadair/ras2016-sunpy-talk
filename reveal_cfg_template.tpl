...
<title>SunPy: Python for Solar Physics</title>
...
require(
    ...
    function(head, Reveal){
            ...
            multiplex: {
                ...
                id: 'c98b9b0cbf7b2e42', // id, obtained from socket.io server
                url: 'mail.cadair.com:1948' // Location of your socket.io server
            },


            // Optional libraries used to extend on reveal.js
            dependencies: [
				{ src: '{{resources.reveal.url_prefix}}/plugin/multiplex/client.js'},
